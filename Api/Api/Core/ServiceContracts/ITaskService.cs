...
namespace Api.Core.ServiceContracts
{
	...
	public interface ITaskService
	{
		...
		public Task<TaskCardResponce> AddTaskCard(TaskCardAddRequest addRequest);
		/// <summary>
		/// Returns all the task cards
		/// </summary>
		/// <returns>A list of TaskCardResponce with all the tasks</returns>
		public Task<List<TaskCardResponce>> GetTaskCards();
		/// <summary>
		...
		public Task<List<TaskCardResponce>> GetTaskCardsFromTaskList(Guid listId);
		/// <summary>
		...
		public Task<bool> DeleteTaskCard(Guid cardId);
		/// <summary>
		...
		public Task<TaskCardResponce> EditTaskCard(TaskCardUpdateRequest updateRequest);
		/// <summary>
		...
		public Task<TaskCardResponce> GetCardById(Guid id);
	}
}
